export default function Bathroom() {
    return (
        <svg className="svg-inline--fa fa-bath" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bath"
             role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-v-58e295d3="">
